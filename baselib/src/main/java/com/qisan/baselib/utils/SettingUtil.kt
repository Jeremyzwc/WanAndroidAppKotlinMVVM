 ...
 */
object SettingUtil {
    private val setting = PreferenceManager.getDefaultSharedPreferences(BaseApp.context)
     ...
     */
    fun getColor(): Int {
        val defaultColor = BaseApp.context.resources.getColor(R.color.colorPrimary)
