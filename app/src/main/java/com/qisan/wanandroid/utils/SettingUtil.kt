 ...
 */
object SettingUtil {
    private val setting = PreferenceManager.getDefaultSharedPreferences(WanApplication.context)
     ...
     */
    fun getColor(): Int {
        val defaultColor = WanApplication.context.resources.getColor(R.color.colorPrimary)
